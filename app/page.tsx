        ...
        <section className="flex w-full flex-col items-center">
          <div className="flex flex-col items-center lg:mx-32 xl:mx-56 2xl:mx-96 ">
            ...
            <p className="py-4 text-center text-slate-200/60 lg:text-xl">
              Your go-to platform for real-time project collaboration. Easily
              work on projects, modify code, and perform CRUD operations on
              files and folders all within one interface.
            </p>
          </div>
